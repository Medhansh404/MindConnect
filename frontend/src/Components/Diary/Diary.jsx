...
const Diary = () => {
  ...
  const handleDeleteDiary = async(index) => {
    ...
    if(response){
      ...
      console.log("Problem Deleting Diary");
    }
  }
  catch(err){
    console.error(err)
        ...
        {isCreating && (
          <div className="min-h-screen py-8 px-4">
            <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-sm p-8 shadow-black">
              <h1 className="text-2xl lg:text-3xl font-bold text-center text-blue-900 mb-6">Create a New Diary</h1>
        ...
        {!isCreating && (
          <div className="py-16">
            <div className="flex justify-between items-center mb-6 lg:mb-10">
              <h1 className="text-3xl lg:text-4xl font-bold text-blue-900">My Thoughts</h1>
              <button 
                className="bg-blue-900 text-lg lg:text-xl text-white font-semibold py-2 px-4 rounded-full hover:bg-customYellow hover:text-black" 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-6 lg:mt-16">
              {diaries.map((diary, index) => (
                <div 
                  key={diary.id} 
                  className="border border-customBlue bg-blue-100 p-5 rounded-xl overflow-hidden"
                >
                  {isEditing === diary.id ? (
                    <>
                      <div className="mb-4">
